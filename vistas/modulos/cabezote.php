        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="vistas/img/icon.ico" width="55px" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img src="vistas/img/icon.ico" width="45px" alt="Logo"></a>
